...
export const DEMO_CONTENT = {
  ...
  brainRegions: [
    { id: 'hippocampus', name: 'Left Hippocampus', role: '⚡ Seizure Origin Zone', color: '#c084fc', pos: [262, 214],
    ...
    { id: 'amygdala', name: 'Amygdala', role: 'First Spread → Emotion', color: '#f472b6', pos: [196, 196],
    ...
    { id: 'insula', name: 'Insular Cortex', role: 'Visceral Sensation', color: '#fbbf24', pos: [238, 150],
    ...
    { id: 'temporal-neocortex', name: 'Temporal Neocortex', role: 'Automatisms', color: '#818cf8', pos: [326, 188],
